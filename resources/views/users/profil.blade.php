                ...
                <form action="{{ route('update-profil', Auth::user()) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="nama" type="text" id="input-nama" class="form-control form-control-alternative @error('nama') is-invalid @enderror" placeholder="nama" value="{{ old('nama',Auth::user()->nama) }}">
                                    @error('nama')
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group">
                            ...
                            <input name="alamat" id="input-alamat" class="form-control form-control-alternative" placeholder="Alamat" value="{{ Auth::user()->alamat }}" type="text">
                        </div>
                        <div class="form-group">
                            <label class="form-control-label" for="input-nomor-hp">Nomor Hp</label>
                            <input name="nomor_hp" onkeypress="return hanyaAngka(event)" id="input-nomor-hp" class="form-control form-control-alternative @error('nomor_hp') is-invalid @enderror" placeholder="Nomor Hp" value="{{ old('nomor_hp',Auth::user()->nomor_hp) }}" type="text">
                            @error('nomor_hp')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
